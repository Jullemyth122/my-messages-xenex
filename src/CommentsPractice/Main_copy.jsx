                            ...
                            <div className="ta">
                                <div className='tp'>
                                    ...
                                    <div className="like-reply">
                                        <div className="like" onClick={e => props.handleLikes(props.name,item.likes_list,props.listid,item)}><ion-icon name="thumbs-up-outline"></ion-icon> <p> {item.likes} </p> </div>
...
function Main() {
    ...
    useEffect(() => {
        ...
        axios.post('http://localhost:3333/comments/add')
    ...
    const handleLikes = (name,comments_likelist,listid,sublist_id) => {
        // console.log('true')
        if (name == null) {
            return null
        } else {
            const index = comments_likelist.findIndex(el => el._id == sublist_id)

            console.log(index)
            console.log(comments_likelist)            
            console.log(sublist_id)
            console.log(comments_likelist._id)            
    ...
    const CommentsDeclaration = () => {
        return listid.map((items,count) => {
            ...
            console.log(items.comments[0]._id)
            ...
            return(
                <Comment
                    ...
                    handleLikes = { e => handleLikes(location.state,items.comments,items._id,items.comment)}
                />
            )
        })
    }
