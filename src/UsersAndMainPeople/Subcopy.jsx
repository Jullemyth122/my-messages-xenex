...
function Main() {
    ...
    useEffect(() => {
        axios.get('https://wanted-people-backend.herokuapp.com/likes')
            .then(prisoners => {
    ...
    const handleLikes = (name,subitem,items) => {
        if (subitem == null) {
            ...
            if (subitem.confirmation_like == false) {
                            ...
                            if (xlikers.people[person >= 0? person : null]._id == subitem._id) {
                                ...
                                return {
                                    ...
                                    people:[{confirmation_like:true,
                                        ...
                                        name:xlikers.people[person >= 0? person : null].name,
                ...
                console.log(subitem._id)
                axios.put(`https://wanted-people-backend.herokuapp.com/likes/item/${items._id}`,{ likes: items.likes,sub_item: subitem.name ,people:[{confirmation_like:true}]})
                ...
                axios.put(`https://wanted-people-backend.herokuapp.com/likes/item/${items._id}`,{ likes: items.likes,sub_item: subitem.name,people:[{confirmation_like:false}]})
                    .then(p => console.log(p))
                    .catch(err => console.log(err))
            }   
    ...
    const handleDislikes = (name,subitem,items) => {
        ...
        if (subitem == null) {
            ...
            if (subitem.confirmation_dislike == false) {
                ...
                console.log(subitem._id)
                axios.put(`https://wanted-people-backend.herokuapp.com/likes/item/${items._id}`,{ dislikes: items.dislikes,sub_item: subitem.name ,people:[{confirmation_dislike:true}]})
                    .then(p => console.log(p))
                    .catch(err => console.log(err))
            } 
                ...
                axios.put(`https://wanted-people-backend.herokuapp.com/likes/item/${items._id}`,{ dislikes: items.dislikes,sub_item: subitem.name,people:[{confirmation_dislike:false}]})
                    .then(p => console.log(p))
                    .catch(err => console.log(err))
            }   
    ...
    const handleFavorite = (name,subitem,items) => {
        ...
        if (subitem == null) {
            ...
            if (subitem.confirmation_favorite == false) {
                ...
                console.log(subitem._id)
                axios.put(`https://wanted-people-backend.herokuapp.com/likes/item/${items._id}`,{ favorites: items.favorites,sub_item: subitem.name ,people:[{confirmation_favorite:true}]})
                    .then(p => console.log(p))
                    .catch(err => console.log(err))
            } 
                ...
                axios.put(`https://wanted-people-backend.herokuapp.com/likes/item/${items._id}`,{ favorites: items.favorites,sub_item: subitem.name,people:[{confirmation_favorite:false}]})
                    .then(p => console.log(p))
                    .catch(err => console.log(err))
            }   
